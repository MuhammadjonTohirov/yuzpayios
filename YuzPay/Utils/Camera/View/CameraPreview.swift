...
public struct CameraPreview: UIViewRepresentable {
    public class VideoPreviewView: UIView {
        ...
        @objc func focusAndExposeTap(gestureRecognizer: UILongPressGestureRecognizer) {
        ...
        public override func layoutSubviews() {
            ...
            focusView.layer.frame = self.bounds
//            let gRecognizer = UILongPressGestureRecognizer(target: self, action: #selector(VideoPreviewView.focusAndExposeTap(gestureRecognizer:)))
//            gRecognizer.minimumPressDuration = 0.3
//            self.addGestureRecognizer(gRecognizer)
    ...
    public var aspectRatio: AVLayerVideoGravity = .resizeAspect
    
    public init(session: AVCaptureSession, aspectRatio: AVLayerVideoGravity = .resizeAspect) {
    ...
    public func makeUIView(context: Context) -> VideoPreviewView {
        ...
        viewFinder.videoPreviewLayer.videoGravity = aspectRatio
        viewFinder.videoPreviewLayer.contentsGravity = .resizeAspect
        return viewFinder
    }
